    ...
    get: function () {
        ...
        Parse.Cloud.httpRequest({
            ...
            success: function(httpResponse) {
                if(this.debug) console.log("[FACTUAL DEBUG] HttpRequest succeded with response: " + JSON.stringify(httpResponse));
                return req.callback(null,httpResponse.data.response);
            },
            error: function(httpResponse) {
                if(this.debug) console.log("HttpRequest failed with response: " + JSON.stringify(httpResponse));
                var error = {
